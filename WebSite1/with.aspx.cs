...
public partial class with : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Int32 widw = 1 * Convert.ToInt32(wid.Text.ToString());
           
            // int amount = (int)Session["balance"] + Convert.ToInt32(depo.Text);
            if (Convert.ToInt32(Session["balance"].ToString())>= widw)
            {
                Int32 amount = Convert.ToInt32(Session["balance"].ToString()) - widw;
                con.Open();
                ...
                Response.Redirect("bal.aspx?t=1");
            }
            else
            {
