<%@ Page Language="C#" AutoEventWireup="true" CodeFile="with.aspx.cs" Inherits="with" %>
...
<center>
        <table id="tab">
          ...
          <td>
               <asp:TextBox ID="wid" runat="server" type="integer"  placeholder="       1000/-"   required minlength="3" maxlength="5" onemptied="Please Enter the Amount!" oninvalid="Amount Must Be Value Between 3 to 5 Digits" title="Amount Must Be Entered In 3-5 Digits Numeric Format!"></asp:TextBox>
          ...
          <tr>
            ...
            <td></td>
            <td id="with" style="float:right; margin-right:145px;">
                 <asp:Button ID="submit" runat="server" style="margin-left:-25px;" Width="300%" Text="Withdraw" onclick="submit_Click" cssid="dep" name=""></asp:Button>
